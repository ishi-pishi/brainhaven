            ...
            return (
              <button
                ...
                className={`
                    ...
                    ${isSelected ? `ring-2 ${r.selected}` : r.color}
                `}
              >
                {r.emoji}
              </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <Popover>
              ...
              <PopoverContent className="w-96 text-sm">
                This information will be analyzed by your AI agent to help you
                understand how you study. Make note of what strategies you used
                and whether they helped you, or whether there were particular
                distractions you want to avoid in the future. You can also note
                things like your environment, stressors, or other study
                conditions, which will be used alongside your productivity
                rating to help you understand where and how you study best.
              </PopoverContent>
            </Popover>
          </div>
          <Textarea
